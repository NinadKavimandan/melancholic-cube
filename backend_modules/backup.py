class Cube:
    ...
    def turnUpper(self, prime=1):
        ...
        #self.swapPieces(self.front, self.right, [0, 1, 2], [0, 1, 2])
        #self.swapPieces(self.right, self.back, [0, 1, 2], [2, 1, 0])
        #self.swapPieces(self.back, self.left, [0, 1, 2], [0, 1, 2])
        self.printCube()
    ...
    def turnDown(self, prime=1):
        ...
        #self.swapPieces(self.front, self.left, [6, 7, 8], [8, 7, 6])
        #self.swapPieces(self.left, self.back, [6, 7, 8], [6, 7, 8])
        #self.swapPieces(self.back, self.right, [6, 7, 8], [6, 7, 8])
        self.printCube()
    ...
    def turnLeft(self, prime=1):
        ...
        #self.swapPieces(self.front, self.up, [0, 3, 6], [0, 3, 6])
        #self.swapPieces(self.up, self.back, [0, 3, 6], [6, 3, 0])
        #self.swapPieces(self.back, self.down, [6, 3, 0], [0, 3, 6])
        self.printCube()
    ...
    def turnRight(self, prime=1):
        ...
        #self.swapPieces(self.front, self.down, [2, 5, 8], [2, 5, 8])
        #self.swapPieces(self.down, self.back, [2, 5, 8], [8, 5, 2])
        #self.swapPieces(self.back, self.up, [8, 5, 2], [2, 5, 8])
        self.printCube()
    ...
    def turnFront(self, prime=1):
        ...
        #self.swapPieces(self.up, self.left, [6, 7, 8], [2, 5, 8])
        #self.swapPieces(self.left, self.down, [2, 5, 8], [0, 1, 2])
        #self.swapPieces(self.down, self.right, [0, 1, 2], [6, 3, 0])
        self.printCube()
    ...
    def turnBack(self, prime=1):
        ...
        #self.shiftSideLayers([self.up, self.right, self.down, self.left], [[0, 1, 2], [2, 5, 8], [8, 7, 6], [6, 3, 0]])
        #self.shiftSideLayers([self.up, self.right, self.down, self.left], [[0, 1, 2], [2, 5, 8], [8, 7, 6], [6, 3, 0]])
        #self.swapPieces(self.up, self.right, [0, 1, 2], [2, 5, 8])
        #self.swapPieces(self.right, self.down, [2, 5, 8], [8, 7, 6])
        #self.swapPieces(self.down, self.left, [6, 7, 8], [0, 3, 6])
        self.printCube()
